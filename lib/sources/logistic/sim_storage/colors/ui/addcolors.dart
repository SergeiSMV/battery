...
import '../bloc/newcolors_bloc.dart';


class AddColors{
  final BuildContext colorsContext;
  final List currentState;
  const AddColors({required this.colorsContext, required this.currentState});
    ...
    return showModalBottomSheet(
      ...
      builder: (context){
        return MultiBlocProvider(
          providers: [
            BlocProvider<NewColorsBloc>(create: (context) => NewColorsBloc()),
          ...
          child: StatefulBuilder(
            builder: (context, state){
              ...
              String color = context.watch<NewColorsBloc>().state;
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(child: Text('добавление цвета', style: TextStyle(color: firmColor, fontSize: 16))),
                            ],
                          ),
                        )
                      ),
                    ...
                    _enterValue('цвет:', color, TextInputType.text, (value) { 
                      context.read<NewColorsBloc>().add(NewColorsChange(data: value.toString()));
                    },),
                    ...
                    isTapped == false ?
                      Container(
                        ...
                        child: TextButton(onPressed: () async {
                          ...
                          await Connection(data: {'color': color}, route: simCreateColors).connect().then((value){
                            value == 'done' ? 
                            {
                              currentState.add({'color': color}),
