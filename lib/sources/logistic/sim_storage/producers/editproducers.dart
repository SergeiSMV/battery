...
class EditProducers{
  ...
  final int index;
  const EditProducers({required this.producersContext, required this.currentState, required this.index});
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(child: Text('редактирование поставщика', style: TextStyle(color: firmColor, fontSize: 16))),
                          ],
                        ),
                      )
                    ),
                  ...
                  _enterValue('поставщик:', currentState[index]['producer'], TextInputType.text, (value) { 
                    currentState[index]['producer'] = value.toString();
                  },),
                  ...
                  isTapped == false ?
                    Container(
                      ...
                      child: TextButton(onPressed: () async {
                        ...
                        await Connection(data: currentState[index], route: simUpdateProducers).connect().then((value){
                          value == 'done' ? 
                          {
